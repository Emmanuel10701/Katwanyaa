...
export default function NavigationSidebar({ 
  ...
  return (
<aside className="fixed lg:relative inset-y-0 left-0 z-50  h-screen bg-white border-r border-gray-200 w-full max-w-[300px] lg:max-w-[280px] xl:max-w-[300px] flex flex-col">
