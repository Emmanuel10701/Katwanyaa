        ...
        <div className="container mx-auto max-w-6xl w-full">
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                >
                  <FiHome className="text-xl group-hover:scale-100 transition-transform duration-300" />
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-3 sm:gap-4">
                            <div className="p-2 sm:p-3 bg-gradient-to-br from-slate-50 to-white group-hover:from-rose-500 group-hover:to-purple-600 group-hover:text-white rounded-lg transition-all duration-300 group-hover:scale-100 shadow-sm">
          ...
          <footer className="mt-8 md:mt-12 lg:mt-16 text-center">
            <p className="text-slate-500 text-sm font-medium">
              &copy; {new Date().getFullYear()} Katwanyaa High in Matungulu Machakos
