...
<div className="flex h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 overflow-hidden transform scale-[0.8] origin-top-left"><div className="flex h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 overflow-hidden transform scale-[0.8] origin-top-left">        {showMobileWarning && <MobileWarningModal />}
