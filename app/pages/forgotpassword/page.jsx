          ...
          <>
            ...
            <motion.div className="relative z-10 text-center mb-4 sm:mb-6" variants={containerVariants}>
              ...
              <div className="flex justify-center flex-wrap gap-1 sm:gap-2 text-xs sm:text-sm font-medium mb-6 sm:mb-8">
                <span className="bg-white/20 text-white px-2 sm:px-3 py-1 rounded-full text-xs">#Security</span>
                <span className="bg-white/20 text-white px-2 sm:px-3 py-1 rounded-full text-xs">#AccountRecovery</span>
              </div>
            </motion.div>
